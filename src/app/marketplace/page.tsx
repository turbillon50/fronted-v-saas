      ...
      <main className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-container px-5 pt-16 md:px-margin-desktop md:pt-24">
          <div className="max-w-2xl">
            <span className="label-caps text-cyber-cyan">Marketplace</span>
            <h1 className="mt-3 font-display text-4xl font-semibold tracking-tight md:text-5xl text-balance">
              Capabilities, ready to compose.
            </h1>
            <p className="mt-4 text-on-surface-variant">
              Every module is configured and operated by B. Auth, payments, messaging, AI, storage —
              install conversationally and remove anytime.
            </p>
          </div>
        </div>
